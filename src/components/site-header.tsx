...
export function SiteHeader() {
  ...
  return (
    ...
    >
      <div className="liquid-glass-header shadow-elevated-soft rounded-full px-6 py-3 flex items-center justify-between">
        {/* Logo */}
        ...
        <nav className="flex items-center gap-10 font-semibold text-base text-foreground/80 absolute left-1/2 -translate-x-1/2">
        ...
        <div className="flex items-center gap-4 flex-shrink-0">
          ...
          <Link
            ...
            className={cn(
              ...
              "rounded-full bg-primary text-primary-foreground hover:bg-primary/80 transition-all font-semibold h-11 px-6 text-base shadow-lg"
            )}
          >
            {t.header.chat}
          </Link>
