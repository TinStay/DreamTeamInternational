...
import { trainingGraph } from "@/lib/seo-graph";
...
export default async function LocaleTrainingPage({
  ...
  return (
    <>
      {/* The trainings as Courses provided by the organization (`lib/seo-graph.ts`). */}
      <script type="application/ld+json" dangerouslySetInnerHTML={jsonLd(trainingGraph(lang))} />
      <TrainingPageView />
    </>
  );
}
